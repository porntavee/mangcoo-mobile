...
class NotificationService {
  ...
  void _refreshToken() {
    _firebaseMessaging.getToken().then((token) async {
      ...
      //   });
      //   print(body);
      //   http.post('${server}m/v2/register/token/create', body: body, headers: {
  ...
  void _tokenRefresh(String newToken) async {
    ...
    // var body = json.encode({'token': newToken});
    // http.post('http://150.95.89.33:8088/qr-api/EventCalendar/notificationtoken',
    //     body: body,
    //     headers: {
    //       "Accept": "application/json",
    //       "Content-Type": "application/json"
