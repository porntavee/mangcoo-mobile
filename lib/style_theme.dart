...
class Styles {
  static ThemeData themeData(bool isDarkTheme, BuildContext context) {
    return ThemeData(
      ...
      accentColor: isDarkTheme ? Color(0xFF2A9EB5) : Color(0xFF2A9EB5),
      backgroundColor: isDarkTheme ? Color(0xFF505050) : Colors.white,
      ...
      textSelectionHandleColor:
          isDarkTheme ? Color(0xFFE4E4E4) : Color(0xFF707070),
